...
use crate::CldrPaths;
use cldr_json::{LangTimeZones, TimeZoneNames};
use icu_datetime::{date::TimeZoneInput, options::components::TimeZoneName, provider::*};
...
mod tests {
    ...
    fn test_basic_cldr_timezones() {
        ...
        let pacific = &time_zones.metazones.as_ref().unwrap()["America_Pacific"];
        assert!(pacific
            .long
            .as_ref()
            .unwrap()
